...
import { myPartODef, myPartPDef, myPartQDef, myPartRDef } from 'desi53';
import { myPartSDef, myPartTDef, myPartUDef, myPartVDef, myPartWDef } from 'desi53b';

const designList: tAllPageDef = {
	'desi53/myPartO': myPartODef,
